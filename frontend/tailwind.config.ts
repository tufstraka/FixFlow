...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Warm, humanized primary palette
        honey: {
          50: '#fffbeb',
          100: '#fef3c7',
          200: '#fde68a',
        ...
        // Rich purple for special elements
        grape: {
          50: '#faf5ff',
          100: '#f3e8ff',
          200: '#e9d5ff',
      ...
      boxShadow: {
        ...
        'honey': '0 4px 20px rgba(245, 158, 11, 0.25)',
        'ocean': '0 4px 20px rgba(20, 184, 166, 0.25)',
        'grape': '0 4px 20px rgba(168, 85, 247, 0.25)',
      },
      backdropBlur: {
        xs: '2px',
      },
